...
export namespace Prisma {
  ...
  */
  ...
  export type Boss_killsCountOutputTypeSelect = {
    boss_kills_deaths?: boolean;
    boss_kills_maps?: boolean;
    boss_kills_players?: boolean;
  };

  export type Boss_killsCountOutputTypeGetPayload<
    S extends boolean | null | undefined | Boss_killsCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof Boss_killsCountOutputType
          ? Boss_killsCountOutputType[P]
          : never;
      }
    : Boss_killsCountOutputType;
  ...
  type GetBoss_killsGroupByPayload<T extends Boss_killsGroupByArgs> =
  ...
  export type boss_killsGetPayload<
    S extends boolean | null | undefined | boss_killsArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? boss_kills
    ...
    ? boss_kills & {
        [P in TruthyKeys<S["include"]>]: P extends "boss_kills_deaths"
          ? Array<boss_kills_deathsGetPayload<S["include"][P]>>
          : P extends "boss_kills_maps"
          ? Array<boss_kills_mapsGetPayload<S["include"][P]>>
          : P extends "boss_kills_players"
          ? Array<boss_kills_playersGetPayload<S["include"][P]>>
          : P extends "_count"
          ? Boss_killsCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (boss_killsArgs | boss_killsFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "boss_kills_deaths"
          ? Array<boss_kills_deathsGetPayload<S["select"][P]>>
          : P extends "boss_kills_maps"
          ? Array<boss_kills_mapsGetPayload<S["select"][P]>>
          : P extends "boss_kills_players"
          ? Array<boss_kills_playersGetPayload<S["select"][P]>>
          : P extends "_count"
          ? Boss_killsCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof boss_kills
          ? boss_kills[P]
          : never;
      }
    : boss_kills;

  type boss_killsCountArgs = Omit<
    boss_killsFindManyArgs,
    "select" | "include"
  > & {
    select?: Boss_killsCountAggregateInputType | true;
  };

  export interface boss_killsDelegate<
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_killsFindUniqueArgs,
    ...
    > extends True
      ...
      : Prisma__boss_killsClient<boss_killsGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends boss_killsFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends Boss_killsAggregateArgs>(
      args: Subset<T, Boss_killsAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_killsAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Boss_killsGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_killsGroupByPayload<T>
   ...
   */
  export class Prisma__boss_killsClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    ...
    boss_kills_deaths<T extends boss_kills$boss_kills_deathsArgs = {}>(
      args?: Subset<T, boss_kills$boss_kills_deathsArgs>
    ): Prisma.PrismaPromise<Array<boss_kills_deathsGetPayload<T>> | Null>;

    boss_kills_maps<T extends boss_kills$boss_kills_mapsArgs = {}>(
      args?: Subset<T, boss_kills$boss_kills_mapsArgs>
    ): Prisma.PrismaPromise<Array<boss_kills_mapsGetPayload<T>> | Null>;

    boss_kills_players<T extends boss_kills$boss_kills_playersArgs = {}>(
      args?: Subset<T, boss_kills$boss_kills_playersArgs>
    ): Prisma.PrismaPromise<Array<boss_kills_playersGetPayload<T>> | Null>;
   ...
   */
  export interface boss_killsFindUniqueArgs
    extends boss_killsFindUniqueArgsBase {
    /**
  ...
  export type boss_killsUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_killsUpdateManyMutationInput,
      boss_killsUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBoss_kills_deathsAggregateType<
    T extends Boss_kills_deathsAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_deaths]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_deathsGroupByPayload<
    T extends Boss_kills_deathsGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Boss_kills_deathsGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Boss_kills_deathsGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type boss_kills_deathsGetPayload<
    S extends boolean | null | undefined | boss_kills_deathsArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? boss_kills_deaths
    ...
    : S extends { include: any } & (
        | boss_kills_deathsArgs
        | boss_kills_deathsFindManyArgs
      )
    ? boss_kills_deaths & {
        [P in TruthyKeys<S["include"]>]: P extends "boss_kills"
          ? boss_killsGetPayload<S["include"][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "boss_kills"
          ? boss_killsGetPayload<S["select"][P]>
          : P extends keyof boss_kills_deaths
          ? boss_kills_deaths[P]
          : never;
      }
    : boss_kills_deaths;

  type boss_kills_deathsCountArgs = Omit<
    boss_kills_deathsFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_deathsDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_deathsFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__boss_kills_deathsClient<
          boss_kills_deathsGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends boss_kills_deathsFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends boss_kills_deathsCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              Boss_kills_deathsCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Boss_kills_deathsAggregateArgs>(
      args: Subset<T, Boss_kills_deathsAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_deathsAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Boss_kills_deathsGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_deathsGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_deathsClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    boss_kills<T extends boss_killsArgs = {}>(
      args?: Subset<T, boss_killsArgs>
    ): Prisma__boss_killsClient<boss_killsGetPayload<T> | Null>;
   ...
   */
  export interface boss_kills_deathsFindUniqueArgs
    extends boss_kills_deathsFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_deathsFindFirstArgs
    extends boss_kills_deathsFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_deathsCreateArgs = {
     ...
     */
    data: XOR<
      boss_kills_deathsCreateInput,
      boss_kills_deathsUncheckedCreateInput
    >;
  };
  ...
  export type boss_kills_deathsUpdateArgs = {
     ...
     */
    data: XOR<
      boss_kills_deathsUpdateInput,
      boss_kills_deathsUncheckedUpdateInput
    >;
    /**
  ...
  export type boss_kills_deathsUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_deathsUpdateManyMutationInput,
      boss_kills_deathsUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBoss_kills_mapsAggregateType<
    T extends Boss_kills_mapsAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_maps]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_mapsGroupByPayload<T extends Boss_kills_mapsGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickArray<Boss_kills_mapsGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof Boss_kills_mapsGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  export type boss_kills_mapsGetPayload<
    S extends boolean | null | undefined | boss_kills_mapsArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? boss_kills_maps
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "boss_kills"
          ? boss_killsGetPayload<S["select"][P]>
          : P extends keyof boss_kills_maps
          ? boss_kills_maps[P]
          : never;
      }
    : boss_kills_maps;

  type boss_kills_mapsCountArgs = Omit<
    boss_kills_mapsFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_mapsDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_mapsFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__boss_kills_mapsClient<
          boss_kills_mapsGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends boss_kills_mapsFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends Boss_kills_mapsAggregateArgs>(
      args: Subset<T, Boss_kills_mapsAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_mapsAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Boss_kills_mapsGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_mapsGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_mapsClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface boss_kills_mapsFindUniqueArgs
    extends boss_kills_mapsFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_mapsFindFirstArgs
    extends boss_kills_mapsFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_mapsUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_mapsUpdateManyMutationInput,
      boss_kills_mapsUncheckedUpdateManyInput
    >;
    /**
  ...
  export type boss_kills_mapsUpsertArgs = {
     ...
     */
    create: XOR<
      boss_kills_mapsCreateInput,
      boss_kills_mapsUncheckedCreateInput
    >;
    /**
     * In case the boss_kills_maps was found with the provided `where` argument, update it with this data.
     */
    update: XOR<
      boss_kills_mapsUpdateInput,
      boss_kills_mapsUncheckedUpdateInput
    >;
  };
  ...
  export type GetBoss_kills_playersAggregateType<
    T extends Boss_kills_playersAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_players]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_playersGroupByPayload<
    T extends Boss_kills_playersGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Boss_kills_playersGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Boss_kills_playersGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type boss_kills_playersGetPayload<
    S extends boolean | null | undefined | boss_kills_playersArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? boss_kills_players
    ...
    ? never
    : S extends { include: any } & (
        | boss_kills_playersArgs
        | boss_kills_playersFindManyArgs
      )
    ? boss_kills_players & {
        [P in TruthyKeys<S["include"]>]: P extends "boss_kills"
          ? boss_killsGetPayload<S["include"][P]>
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "boss_kills"
          ? boss_killsGetPayload<S["select"][P]>
          : P extends keyof boss_kills_players
          ? boss_kills_players[P]
          : never;
      }
    : boss_kills_players;

  type boss_kills_playersCountArgs = Omit<
    boss_kills_playersFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_playersDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_playersFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__boss_kills_playersClient<
          boss_kills_playersGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends boss_kills_playersFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends boss_kills_playersCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              Boss_kills_playersCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Boss_kills_playersAggregateArgs>(
      args: Subset<T, Boss_kills_playersAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_playersAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Boss_kills_playersGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_playersGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_playersClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface boss_kills_playersFindUniqueArgs
    extends boss_kills_playersFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_playersFindFirstArgs
    extends boss_kills_playersFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_playersCreateArgs = {
     ...
     */
    data: XOR<
      boss_kills_playersCreateInput,
      boss_kills_playersUncheckedCreateInput
    >;
  };
  ...
  export type boss_kills_playersUpdateArgs = {
     ...
     */
    data: XOR<
      boss_kills_playersUpdateInput,
      boss_kills_playersUncheckedUpdateInput
    >;
    /**
  ...
  export type boss_kills_playersUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_playersUpdateManyMutationInput,
      boss_kills_playersUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBoss_kills_progress_cacheAggregateType<
    T extends Boss_kills_progress_cacheAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_progress_cache]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_progress_cacheGroupByPayload<
    T extends Boss_kills_progress_cacheGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Boss_kills_progress_cacheGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Boss_kills_progress_cacheGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type boss_kills_progress_cacheGetPayload<
    S extends boolean | null | undefined | boss_kills_progress_cacheArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? never
    : S extends { include: any } & (
        | boss_kills_progress_cacheArgs
        | boss_kills_progress_cacheFindManyArgs
      )
    ? boss_kills_progress_cache
    : S extends { select: any } & (
        | boss_kills_progress_cacheArgs
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof boss_kills_progress_cache
          ? boss_kills_progress_cache[P]
          : never;
      }
    : boss_kills_progress_cache;

  type boss_kills_progress_cacheCountArgs = Omit<
    boss_kills_progress_cacheFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_progress_cacheDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_progress_cacheFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
      ...
      "boss_kills_progress_cache"
    > extends True
      ? Prisma__boss_kills_progress_cacheClient<
          boss_kills_progress_cacheGetPayload<T>
        >
      : Prisma__boss_kills_progress_cacheClient<
          boss_kills_progress_cacheGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends boss_kills_progress_cacheFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends boss_kills_progress_cacheCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              Boss_kills_progress_cacheCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Boss_kills_progress_cacheAggregateArgs>(
      args: Subset<T, Boss_kills_progress_cacheAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_progress_cacheAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<
        T,
        Boss_kills_progress_cacheGroupByArgs,
        OrderByArg
      > &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_progress_cacheGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_progress_cacheClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface boss_kills_progress_cacheFindUniqueArgs
    extends boss_kills_progress_cacheFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_progress_cacheFindFirstArgs
    extends boss_kills_progress_cacheFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_progress_cacheCreateArgs = {
     ...
     */
    data: XOR<
      boss_kills_progress_cacheCreateInput,
      boss_kills_progress_cacheUncheckedCreateInput
    >;
  };
  ...
  export type boss_kills_progress_cacheUpdateArgs = {
     ...
     */
    data: XOR<
      boss_kills_progress_cacheUpdateInput,
      boss_kills_progress_cacheUncheckedUpdateInput
    >;
    /**
  ...
  export type boss_kills_progress_cacheUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_progress_cacheUpdateManyMutationInput,
      boss_kills_progress_cacheUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBoss_kills_rankings_guildAggregateType<
    T extends Boss_kills_rankings_guildAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_rankings_guild]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_rankings_guildGroupByPayload<
    T extends Boss_kills_rankings_guildGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Boss_kills_rankings_guildGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Boss_kills_rankings_guildGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type boss_kills_rankings_guildGetPayload<
    S extends boolean | null | undefined | boss_kills_rankings_guildArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? never
    : S extends { include: any } & (
        | boss_kills_rankings_guildArgs
        | boss_kills_rankings_guildFindManyArgs
      )
    ? boss_kills_rankings_guild
    : S extends { select: any } & (
        | boss_kills_rankings_guildArgs
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof boss_kills_rankings_guild
          ? boss_kills_rankings_guild[P]
          : never;
      }
    : boss_kills_rankings_guild;

  type boss_kills_rankings_guildCountArgs = Omit<
    boss_kills_rankings_guildFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_rankings_guildDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_rankings_guildFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
      ...
      "boss_kills_rankings_guild"
    > extends True
      ? Prisma__boss_kills_rankings_guildClient<
          boss_kills_rankings_guildGetPayload<T>
        >
      : Prisma__boss_kills_rankings_guildClient<
          boss_kills_rankings_guildGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends boss_kills_rankings_guildFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends boss_kills_rankings_guildCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              Boss_kills_rankings_guildCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Boss_kills_rankings_guildAggregateArgs>(
      args: Subset<T, Boss_kills_rankings_guildAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_rankings_guildAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<
        T,
        Boss_kills_rankings_guildGroupByArgs,
        OrderByArg
      > &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_rankings_guildGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_rankings_guildClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface boss_kills_rankings_guildFindUniqueArgs
    extends boss_kills_rankings_guildFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_rankings_guildFindFirstArgs
    extends boss_kills_rankings_guildFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_rankings_guildCreateArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guildCreateInput,
      boss_kills_rankings_guildUncheckedCreateInput
    >;
  };
  ...
  export type boss_kills_rankings_guildUpdateArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guildUpdateInput,
      boss_kills_rankings_guildUncheckedUpdateInput
    >;
    /**
  ...
  export type boss_kills_rankings_guildUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guildUpdateManyMutationInput,
      boss_kills_rankings_guildUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBoss_kills_rankings_guild_cacheAggregateType<
    T extends Boss_kills_rankings_guild_cacheAggregateArgs
  > = {
    [P in keyof T & keyof AggregateBoss_kills_rankings_guild_cache]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetBoss_kills_rankings_guild_cacheGroupByPayload<
    T extends Boss_kills_rankings_guild_cacheGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<Boss_kills_rankings_guild_cacheGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof Boss_kills_rankings_guild_cacheGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
            : GetScalarType<
                T[P],
                Boss_kills_rankings_guild_cacheGroupByOutputType[P]
              >
          : GetScalarType<
              T[P],
              Boss_kills_rankings_guild_cacheGroupByOutputType[P]
  ...
  export type boss_kills_rankings_guild_cacheGetPayload<
    S extends boolean | null | undefined | boss_kills_rankings_guild_cacheArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? never
    : S extends { include: any } & (
        | boss_kills_rankings_guild_cacheArgs
        | boss_kills_rankings_guild_cacheFindManyArgs
      )
    ? boss_kills_rankings_guild_cache
    : S extends { select: any } & (
        | boss_kills_rankings_guild_cacheArgs
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof boss_kills_rankings_guild_cache
          ? boss_kills_rankings_guild_cache[P]
          : never;
      }
    : boss_kills_rankings_guild_cache;

  type boss_kills_rankings_guild_cacheCountArgs = Omit<
    boss_kills_rankings_guild_cacheFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface boss_kills_rankings_guild_cacheDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends boss_kills_rankings_guild_cacheFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
      ...
      "boss_kills_rankings_guild_cache"
    > extends True
      ? Prisma__boss_kills_rankings_guild_cacheClient<
          boss_kills_rankings_guild_cacheGetPayload<T>
        >
      : Prisma__boss_kills_rankings_guild_cacheClient<
          boss_kills_rankings_guild_cacheGetPayload<T> | null,
          null
        >;
     ...
     **/
    findUniqueOrThrow<
      T extends boss_kills_rankings_guild_cacheFindUniqueOrThrowArgs
    >(
      args?: SelectSubset<
        T,
        boss_kills_rankings_guild_cacheFindUniqueOrThrowArgs
      >
    ): Prisma__boss_kills_rankings_guild_cacheClient<
      boss_kills_rankings_guild_cacheGetPayload<T>
    >;
     ...
     **/
    findFirst<
      T extends boss_kills_rankings_guild_cacheFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     **/
    findFirstOrThrow<
      T extends boss_kills_rankings_guild_cacheFindFirstOrThrowArgs
    >(
      args?: SelectSubset<
        T,
        boss_kills_rankings_guild_cacheFindFirstOrThrowArgs
      >
    ): Prisma__boss_kills_rankings_guild_cacheClient<
      boss_kills_rankings_guild_cacheGetPayload<T>
    >;
    ...
    findMany<T extends boss_kills_rankings_guild_cacheFindManyArgs>(
      ...
      Array<boss_kills_rankings_guild_cacheGetPayload<T>>
    >;
    ...
    count<T extends boss_kills_rankings_guild_cacheCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              Boss_kills_rankings_guild_cacheCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Boss_kills_rankings_guild_cacheAggregateArgs>(
      args: Subset<T, Boss_kills_rankings_guild_cacheAggregateArgs>
    ): Prisma.PrismaPromise<GetBoss_kills_rankings_guild_cacheAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<
        T,
        Boss_kills_rankings_guild_cacheGroupByArgs,
        OrderByArg
      > &
        InputErrors
    ): {} extends InputErrors
      ? GetBoss_kills_rankings_guild_cacheGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__boss_kills_rankings_guild_cacheClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface boss_kills_rankings_guild_cacheFindUniqueArgs
    extends boss_kills_rankings_guild_cacheFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface boss_kills_rankings_guild_cacheFindFirstArgs
    extends boss_kills_rankings_guild_cacheFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type boss_kills_rankings_guild_cacheCreateArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guild_cacheCreateInput,
      boss_kills_rankings_guild_cacheUncheckedCreateInput
    >;
  };
  ...
  export type boss_kills_rankings_guild_cacheUpdateArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guild_cacheUpdateInput,
      boss_kills_rankings_guild_cacheUncheckedUpdateInput
    >;
    /**
  ...
  export type boss_kills_rankings_guild_cacheUpdateManyArgs = {
     ...
     */
    data: XOR<
      boss_kills_rankings_guild_cacheUpdateManyMutationInput,
      boss_kills_rankings_guild_cacheUncheckedUpdateManyInput
    >;
    /**
  ...
  export type Boss_killsScalarFieldEnum =
    (typeof Boss_killsScalarFieldEnum)[keyof typeof Boss_killsScalarFieldEnum];
  ...
  export type Boss_kills_deathsScalarFieldEnum =
    (typeof Boss_kills_deathsScalarFieldEnum)[keyof typeof Boss_kills_deathsScalarFieldEnum];
  ...
  export type Boss_kills_mapsScalarFieldEnum =
    (typeof Boss_kills_mapsScalarFieldEnum)[keyof typeof Boss_kills_mapsScalarFieldEnum];
  ...
  export type Boss_kills_playersScalarFieldEnum =
    (typeof Boss_kills_playersScalarFieldEnum)[keyof typeof Boss_kills_playersScalarFieldEnum];
  ...
  export type Boss_kills_progress_cacheScalarFieldEnum =
    (typeof Boss_kills_progress_cacheScalarFieldEnum)[keyof typeof Boss_kills_progress_cacheScalarFieldEnum];
  ...
  export type Boss_kills_rankings_guildScalarFieldEnum =
    (typeof Boss_kills_rankings_guildScalarFieldEnum)[keyof typeof Boss_kills_rankings_guildScalarFieldEnum];
  ...
  export type Boss_kills_rankings_guild_cacheScalarFieldEnum =
    (typeof Boss_kills_rankings_guild_cacheScalarFieldEnum)[keyof typeof Boss_kills_rankings_guild_cacheScalarFieldEnum];
  ...
  export type Boss_killsRelationFilter = {
    is?: boss_killsWhereInput;
    isNot?: boss_killsWhereInput;
  };
  ...
  export type boss_kills_deathsCreateNestedManyWithoutBoss_killsInput = {
    create?: XOR<
      Enumerable<boss_kills_deathsCreateWithoutBoss_killsInput>,
      Enumerable<boss_kills_deathsUncheckedCreateWithoutBoss_killsInput>
    >;
  ...
  export type boss_kills_mapsCreateNestedManyWithoutBoss_killsInput = {
    create?: XOR<
      Enumerable<boss_kills_mapsCreateWithoutBoss_killsInput>,
      Enumerable<boss_kills_mapsUncheckedCreateWithoutBoss_killsInput>
    >;
  ...
  export type boss_kills_playersCreateNestedManyWithoutBoss_killsInput = {
    create?: XOR<
      Enumerable<boss_kills_playersCreateWithoutBoss_killsInput>,
      Enumerable<boss_kills_playersUncheckedCreateWithoutBoss_killsInput>
    >;
  ...
  export type boss_killsCreateNestedOneWithoutBoss_kills_deathsInput = {
    create?: XOR<
      boss_killsCreateWithoutBoss_kills_deathsInput,
      boss_killsUncheckedCreateWithoutBoss_kills_deathsInput
    >;
  ...
  export type boss_killsUpdateOneRequiredWithoutBoss_kills_deathsNestedInput = {
    ...
    connect?: boss_killsWhereUniqueInput;
    update?: XOR<
      boss_killsUpdateWithoutBoss_kills_deathsInput,
      boss_killsUncheckedUpdateWithoutBoss_kills_deathsInput
    >;
  };

  export type boss_killsCreateNestedOneWithoutBoss_kills_mapsInput = {
    create?: XOR<
      boss_killsCreateWithoutBoss_kills_mapsInput,
      boss_killsUncheckedCreateWithoutBoss_kills_mapsInput
    >;
  ...
  export type boss_killsUpdateOneRequiredWithoutBoss_kills_mapsNestedInput = {
    ...
    connect?: boss_killsWhereUniqueInput;
    update?: XOR<
      boss_killsUpdateWithoutBoss_kills_mapsInput,
      boss_killsUncheckedUpdateWithoutBoss_kills_mapsInput
    >;
  };

  export type boss_killsCreateNestedOneWithoutBoss_kills_playersInput = {
    create?: XOR<
      boss_killsCreateWithoutBoss_kills_playersInput,
      boss_killsUncheckedCreateWithoutBoss_kills_playersInput
    >;
  ...
  export type boss_killsUpdateOneRequiredWithoutBoss_kills_playersNestedInput =
    {
      ...
      connect?: boss_killsWhereUniqueInput;
      update?: XOR<
        boss_killsUpdateWithoutBoss_kills_playersInput,
        boss_killsUncheckedUpdateWithoutBoss_kills_playersInput
      >;
    };
  ...
  export type boss_kills_deathsCreateOrConnectWithoutBoss_killsInput = {
    where: boss_kills_deathsWhereUniqueInput;
    create: XOR<
      boss_kills_deathsCreateWithoutBoss_killsInput,
      boss_kills_deathsUncheckedCreateWithoutBoss_killsInput
    >;
  };
  ...
  export type boss_kills_mapsCreateOrConnectWithoutBoss_killsInput = {
    where: boss_kills_mapsWhereUniqueInput;
    create: XOR<
      boss_kills_mapsCreateWithoutBoss_killsInput,
      boss_kills_mapsUncheckedCreateWithoutBoss_killsInput
    >;
  };
  ...
  export type boss_kills_playersCreateOrConnectWithoutBoss_killsInput = {
    where: boss_kills_playersWhereUniqueInput;
    create: XOR<
      boss_kills_playersCreateWithoutBoss_killsInput,
      boss_kills_playersUncheckedCreateWithoutBoss_killsInput
    >;
  };
  ...
  export type boss_kills_deathsUpsertWithWhereUniqueWithoutBoss_killsInput = {
    where: boss_kills_deathsWhereUniqueInput;
    update: XOR<
      boss_kills_deathsUpdateWithoutBoss_killsInput,
      boss_kills_deathsUncheckedUpdateWithoutBoss_killsInput
    >;
    create: XOR<
      boss_kills_deathsCreateWithoutBoss_killsInput,
      boss_kills_deathsUncheckedCreateWithoutBoss_killsInput
  ...
  export type boss_kills_deathsUpdateManyWithWhereWithoutBoss_killsInput = {
    ...
    data: XOR<
      boss_kills_deathsUpdateManyMutationInput,
      boss_kills_deathsUncheckedUpdateManyWithoutBoss_kills_deathsInput
    >;
  };
  ...
  export type boss_kills_mapsUpsertWithWhereUniqueWithoutBoss_killsInput = {
    where: boss_kills_mapsWhereUniqueInput;
    update: XOR<
      boss_kills_mapsUpdateWithoutBoss_killsInput,
      boss_kills_mapsUncheckedUpdateWithoutBoss_killsInput
    >;
    create: XOR<
      boss_kills_mapsCreateWithoutBoss_killsInput,
      boss_kills_mapsUncheckedCreateWithoutBoss_killsInput
  ...
  export type boss_kills_mapsUpdateManyWithWhereWithoutBoss_killsInput = {
    ...
    data: XOR<
      boss_kills_mapsUpdateManyMutationInput,
      boss_kills_mapsUncheckedUpdateManyWithoutBoss_kills_mapsInput
    >;
  };
  ...
  export type boss_kills_playersUpsertWithWhereUniqueWithoutBoss_killsInput = {
    where: boss_kills_playersWhereUniqueInput;
    update: XOR<
      boss_kills_playersUpdateWithoutBoss_killsInput,
      boss_kills_playersUncheckedUpdateWithoutBoss_killsInput
    >;
    create: XOR<
      boss_kills_playersCreateWithoutBoss_killsInput,
      boss_kills_playersUncheckedCreateWithoutBoss_killsInput
  ...
  export type boss_kills_playersUpdateManyWithWhereWithoutBoss_killsInput = {
    ...
    data: XOR<
      boss_kills_playersUpdateManyMutationInput,
      boss_kills_playersUncheckedUpdateManyWithoutBoss_kills_playersInput
    >;
  };
