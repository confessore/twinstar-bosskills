...
export default function HealingDoneWidget(props: Props) {
  ...
  return (
    <div className="m-0.5 flex w-96 max-w-full flex-col">
      <p className="m-0.5 text-3xl font-bold">Healing Done</p>
              ...
              width_percent={
                index === 0
                  ...
                  : calculatePercentHealingDone(
                      parseInt(boss_kills_players[0].healingDone.toString()) +
                        parseInt(boss_kills_players[0].absorbDone.toString()),
                      parseInt(boss_kills_player.healingDone.toString()) +
                        parseInt(boss_kills_player.absorbDone.toString())
                    ) + "%"
              }
